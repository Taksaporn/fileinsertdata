...
<html lang="en">
 <head>
  ...
  <title>Import Excel File To MySql Database Using php</title>
 </head>
 <body>    
    <br><br>
        <div class="container">
            <div class="row"><br>
                ...
                <div class="col-md-6" id="form-login">
                    <form class="well" action="setmarketimport.php" method="post" name="upload_excel" enctype="multipart/form-data">
                        <fieldset>
